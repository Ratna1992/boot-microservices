package com.ratna.microservices.faulttolerance.ratelimiter;
...
public class RateLimitController {
	...
	public ResponseEntity<String> getMessage(@RequestParam(value = "name", defaultValue = "Hellow") String name) {
